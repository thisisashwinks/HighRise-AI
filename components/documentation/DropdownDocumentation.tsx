      ...
      examples={[
        {
          ...
          description: 'A standard dropdown menu displaying a list of available options. The dropdown provides a clean and organized way to present choices, with clear visual hierarchy and easy selection. Options are displayed in a scrollable list when there are many items.',
          media: {
            type: 'image',
            url: '/examples/dropdown/Dropdown Options.png',
            alt: 'Dropdown menu with list of options',
          },
          tags: ['options', 'menu', 'selection'],
        },
        {
          title: 'AI Select Dropdown Item',
          description: 'A dropdown menu item enhanced with AI selection capabilities. This feature allows users to leverage AI assistance when choosing from dropdown options, providing intelligent suggestions or automated selection based on context and user preferences.',
          media: {
            type: 'image',
            url: '/examples/dropdown/AI Select Dropdown Item.png',
            alt: 'AI-powered dropdown item selection',
          },
          tags: ['ai', 'selection', 'assistance'],
        },
        {
          title: 'AI Assist in Dropdown Options',
          description: 'Dropdown menu with integrated AI assistance features that help users make better selections. The AI can provide contextual suggestions, highlight recommended options, or offer intelligent filtering to streamline the selection process and improve user experience.',
          media: {
            type: 'image',
            url: '/examples/dropdown/AI Assist in Dropdown Options.png',
            alt: 'Dropdown menu with AI assistance features',
          },
          tags: ['ai', 'assist', 'suggestions', 'contextual'],
        },
      ]}
    />
  );
