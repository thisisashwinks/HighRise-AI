...
export const ToggleCardGroupDocumentation: React.FC = () => {
  return (
    <ComponentDocTemplate
      ...
      examples={[
        {
          title: 'Basic Toggle Card Group',
          description: 'Simple toggle card group with multiple options in vertical layout. Shows default unchecked state.',
          code: `<ToggleCardGroup
  options={[
    { 
      value: '1', 
      label: 'Business plan',
    ...
    { 
      ...
      description: 'Includes unlimited users, 100GB individual data and priority support.'
    }
  ]}
/>`,
          tags: ['basic', 'vertical'],
        },
        {
          ...
          description: 'Toggle card group arranged horizontally. Best for compact layouts when cards have short content.',
          code: `<ToggleCardGroup
...
/>`,
        ...
        {
          title: 'With Icons',
          description: 'Toggle card group with icons providing visual distinction and context for each option.',
          code: `<ToggleCardGroup
  options={[
    { 
      value: '1', 
...
/>`,
        ...
        },
        {
          ...
          description: 'Toggle card group with pre-selected values. Demonstrates controlled component usage.',
          code: `<ToggleCardGroup
  value={['1', '3']}
  options={[
    { value: '1', label: 'Option 1' },
...
/>`,
        ...
        {
          title: 'Error State',
          description: 'Toggle card group with error state. Used for validation feedback.',
          code: `<ToggleCardGroup
  options={[
    { 
      value: '1', 
...
/>`,
        ...
        },
        {
          ...
          description: 'Toggle card group with disabled state. Individual cards can also be disabled.',
          code: `<ToggleCardGroup
  options={[
    { value: '1', label: 'Option 1' },
...
/>`,
        ...
        },
        {
          ...
          description: 'Toggle card group where individual cards have custom icons instead of default icons.',
          code: `<ToggleCardGroup
  options={[
    { 
      value: '1', 
...
/>`,
          tags: ['custom-icons', 'variants'],
        },
        {
          title: 'Plan Selection',
          description: 'Toggle card group used for plan or tier selection with detailed descriptions.',
          code: `<ToggleCardGroup
  options={[
    { 
      value: 'basic', 
