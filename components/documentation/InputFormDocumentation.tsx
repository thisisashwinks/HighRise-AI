      ...
      examples={[
        {
          ...
          description: 'Stripe\'s registration form demonstrates excellent use of sections, clear labels, and progressive disclosure. Fields are grouped logically with visual separation.',
          media: {
            type: 'image',
            url: '/examples/input-form/stripe-registration.png',
            alt: 'Stripe registration form with organized sections',
          },
          productName: 'Stripe',
          productUrl: 'https://stripe.com',
          tags: ['registration', 'multi-step', 'sections'],
          critique: 'Clear section organization makes the form feel less overwhelming. The use of icons and dividers helps users understand the form structure. However, the form could benefit from inline validation feedback.',
          highLevelApplication: 'HighLevel could use this pattern for user onboarding, account setup, and lead capture forms. We could enhance it with AI-powered field suggestions and auto-completion.',
        },
        {
          title: 'Settings Form with Multiple Sections',
          description: 'Notion\'s settings forms use clear section labels with icons, logical grouping, and consistent spacing. The two-column layout efficiently uses space.',
          media: {
            type: 'image',
            url: '/examples/input-form/notion-settings.png',
            alt: 'Notion settings form with multiple sections',
          },
          productName: 'Notion',
          productUrl: 'https://www.notion.so',
          tags: ['settings', 'sections', 'icons'],
          critique: 'The section organization with icons makes it easy to scan and find relevant settings. The consistent spacing creates a professional appearance. The form could use better error handling.',
          highLevelApplication: 'HighLevel could apply this pattern to settings pages, profile editing, and configuration forms. We could add AI-powered suggestions for optimal settings based on user behavior.',
        },
        {
          title: 'Contact Form with Validation',
          description: 'HubSpot\'s contact forms demonstrate excellent use of sections, clear labels, and real-time validation. The form adapts responsively to different screen sizes.',
          media: {
            type: 'image',
            url: '/examples/input-form/hubspot-contact.png',
            alt: 'HubSpot contact form with validation',
          },
          productName: 'HubSpot',
          productUrl: 'https://www.hubspot.com',
          tags: ['contact', 'validation', 'responsive'],
          critique: 'The form structure is clear and the validation provides helpful feedback. The use of sections helps organize related fields. However, the form could benefit from better error message placement.',
          highLevelApplication: 'HighLevel could use this pattern for lead capture forms, contact pages, and data collection forms. We could enhance it with AI-powered field validation and smart defaults.',
        },
      ]}
    />
  );
